class CommentsController < ApplicationController
  ...
  def create_article_comments
    ...
    CommentMailer.comment_notification_email_articles(@author, @comment.user).deliver
  ...
  def create_techword_comments
   ...
   CommentMailer.comment_notification_email_techwords(@author, @comment.user).deliver
